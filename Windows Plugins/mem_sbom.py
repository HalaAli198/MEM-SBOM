...
class MEM_SBOM(interfaces.plugins.PluginInterface):
    ...
    def _collect_all(self):
        from volatility3.plugins.windows.module_extractor import Module_Extractor
        ...
        print(f"{'='*60}")
        from volatility3.plugins.windows.module_classifier import Module_Classifier
        ...
        if self.config.get('dep', False):
          from volatility3.plugins.windows.dependency_generator import Dependency_Generator
          print(f"\n{'='*60}")
